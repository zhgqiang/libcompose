...
WORKDIR /go/src/github.com/zhgqiang/libcompose
...
ENV COMPOSE_BINARY /go/src/github.com/zhgqiang/libcompose/libcompose-cli
ENV USER root

# Wrap all commands in the "docker-in-docker" script to allow nested containers
ENTRYPOINT ["hack/dind"]

COPY . /go/src/github.com/zhgqiang/libcompose
